...
nav_msgs::Odometry delta_p, past_p, p, vel;
...
void odomCallback(const nav_msgs::Odometry& msg)
{
	...
	delta_p.pose.pose.position.x = p.pose.pose.position.x - past_p.pose.pose.position.x;
	delta_p.pose.pose.position.y = p.pose.pose.position.y - past_p.pose.pose.position.y;
	
	past_p.pose.pose.position.x = msg.pose.pose.position.x;
	past_p.pose.pose.position.y = msg.pose.pose.position.y;
	
	vel.twist.twist.linear.x = delta_p.pose.pose.position.x/0.02;
	vel.twist.twist.linear.y = delta_p.pose.pose.position.y/0.02;
	ROS_INFO("v_x : [%f] ,  v_y : [%f]", vel.twist.twist.linear.x, vel.twist.twist.linear.y);
